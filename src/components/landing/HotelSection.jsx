...
export default function HotelSection({ t }) {
  ...
  return (
    <section id="hotels" className="py-20 lg:py-32 bg-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <div className="w-full h-[500px] bg-gradient-to-br from-orange-50 to-[#15B46A]/10 rounded-3xl flex items-center justify-center shadow-2xl">
              ...
              <motion.div
                ...
                className="absolute bottom-10 -left-10 bg-white p-5 rounded-2xl shadow-xl"
              >
