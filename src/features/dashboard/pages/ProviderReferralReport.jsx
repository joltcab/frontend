...
export default function ProviderReferralReport() {
  ...
  const loadReport = async () => {
    try {
      const data = await adminService.getProviderReferralReport();
      setStats({
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-6">Provider Referral Report</h1>
      ...
      <div className="bg-white rounded-xl shadow border border-gray-200">
        <div className="p-6 border-b">
          <h2 className="text-xl font-bold">Top Provider Referrers</h2>
        </div>
